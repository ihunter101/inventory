        ...
        <CardContent>
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm text-muted-foreground">
              Showing: <span className="font-medium text-foreground">{drafts.length}</span> item{drafts.length !== 1 ? 's' : ''}
              {grnId && <> (filtered by GRN: <span className="font-mono">{grnId.slice(0, 8)}...</span>)</>}
            </div>
          </div>
        </CardContent>
      </Card>
