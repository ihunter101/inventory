 ...
 */
function generatePurchaseOrderPDFBuffer(data) {
    var _a, _b, _c;
    ...
    // Subtotal
    const computedSubtotal = (_a = data.subtotal) !== null && _a !== void 0 ? _a : data.items.reduce((sum, item) => sum + item.total, 0);
    const tax = (_b = data.tax) !== null && _b !== void 0 ? _b : 0;
    const total = (_c = data.total) !== null && _c !== void 0 ? _c : computedSubtotal + tax;
    doc.setFontSize(9);
    doc.setTextColor(...lightGray);
    doc.setFont("helvetica", "normal");
