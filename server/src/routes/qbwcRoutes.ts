...
//       createSession(token, "paymentWrites");

//       console.log("========== QBWC PAYMENT-ONLY AUTH ==========");
...
//       if (!session) {
//         console.log("QBWC sendRequestXML: no active session.");
...
//       const paymentWriteBatch =
//         await getPendingQuickBooksPaymentWriteBatchXML();

//       if (!paymentWriteBatch) {
//         console.log("QBWC payment-only: no pending payment writes left.");
...
//       console.log("========== QBWC PAYMENT WRITE SEND ==========");
//       console.log("Payment batch size:", paymentWriteBatch.batchSize);
//       console.log("Payments sent in this batch:", paymentWriteBatch.sentCount);
//       console.log(
//         "Remaining pending after this batch:",
...
//       console.log("========== QBWC PAYMENT WRITE RESPONSE ==========");
//       console.log("QB HRESULT:", hresult);
//       console.log("QB MESSAGE:", message);
//       console.log("QB RESPONSE LENGTH:", responseXml?.length);

//       if (hresult || message) {
//         console.error("QuickBooks/Web Connector returned an error:", {
//           hresult,
//           message,
//         });
...
//       if (!session) {
//         console.log("QBWC receiveResponseXML: no active session.");
...
//         const handledPaymentWrite =
//           await handleReceivePaymentAddResponse(decodedResponseXml);

//         if (!handledPaymentWrite) {
//           console.log(
//             "QBWC payment-only: response was not handled as a payment write response."
//           );
...
//         const percent = remainingPendingPaymentWrites > 0 ? 50 : 100;

//         console.log("PAYMENT WRITE remaining:", remainingPendingPaymentWrites);
//         console.log("PAYMENT WRITE percent returned:", percent);
...
//         );
//       } catch (error) {
//         console.error("Error handling QuickBooks payment response:", error);
...
//     console.error("Unknown QBWC SOAP action:", xml.slice(0, 500));
...
//     );
//   } catch (error) {
//     console.error("QBWC payment-only route error:", error);
